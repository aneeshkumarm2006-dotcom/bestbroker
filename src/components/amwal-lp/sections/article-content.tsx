  ...
  return (
    <section id="about" className="scroll-mt-24">
      <LpContainer className="pt-10 [@media(max-width:768px)]:pt-8">
        <h2 className={H2}>{t("ما هو التداول عبر الإنترنت؟")}</h2>
        <H2Bar />
        ...
        <p className={BODY}>
          {t("يمكن للمتداولين الاستثمار في مجموعة متنوعة من الأسواق، بما في ذلك:")}
        </p>
        ...
        <h2 className={`${H2} ${GAP}`}>{t("فوائد التداول عبر الإنترنت")}</h2>
        <H2Bar />
        ...
        <h2 className={`${H2} ${GAP}`}>{t("اختيار وسيط التداول")}</h2>
        <H2Bar />
